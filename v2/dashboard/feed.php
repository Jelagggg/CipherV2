            ...
            <div class="col-md-12">
              <form method="POST">
                <div class="card ">
                  ...
                  <div class="card-body">
                    <style type="text/css">.img{width: 50px;border-radius: 90%} </style>
                      <? $userinf = "SELECT * FROM feed";
                        if($resultss = mysqli_query($db, $userinf)){
                            if(mysqli_num_rows($resultss) > 0){
                                while($rowusr = mysqli_fetch_array($resultss)){ ?>
                    <div class="card">
                      <h6 class="card-subtitle mb-2 text-muted text-left"><a target="_blank" href="https://steamcommunity.com/profiles/dzq"> - <? echo htmlspecialchars($rowusr['usr']); ?></a></h6><p class="card-text float-left"><? echo htmlentities($rowusr['content']); ?></p>
                    </div>
                    <? } } } ?>
                    <div class="card">
                      <div class="clearfix"></div>
                      <h6 class="mb-2 text-left">&nbsp;<img class="img" src="../assets/img/faces/base.jpg" /><a target="_blank" href="https://steamcommunity.com/profiles/dzq"> - Ben</a></h6><p class="card-text float-left">&nbsp; YOYOOYOYOYOOYOYYO</p>
                    </div>
                    <div class="card">
                      <div class="clearfix"></div>
                      <h6 class="mb-2 text-left">&nbsp;<img class="img" src="../assets/img/faces/base.jpg" /><a target="_blank" href="https://steamcommunity.com/profiles/dzq"> - Ben</a></h6><p class="card-text float-left">&nbsp; YOYOOYOYOYOOYOYYO</p>
                  ...
                  <div class="card-footer text-right">    
                    <div class="form-check mr-auto">
                      ...
                      <button class="btn btn-not" disabled> <i class="fas fa-plus"></i> Créer</button>
                  <button type="submit" name="addpayload" class="btn btn-success"> <i class="fas fa-plus"></i> Créer</button>
                  </div>
                </div>
              </form>
            </div>
