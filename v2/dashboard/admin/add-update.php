                ...
                <div class="card ">
                  ...
                  <div class="card-body ">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nompay" required="true">
                    </div>
                    <div class="form-group">
                      <label class="bmd-label-floating"> Catégorie </label>
                      <input type="text" class="form-control" name="cate" required="true">
                    </div>
                    <div class="form-group">
                      <label class="bmd-label-floating"> Contenu </label>
                      <textarea class="form-control" rows="20" name="contenup"></textarea> 
                    </div>
                    <div class="category form-category">Catégorie disponible : </div>
                  </div>
